...
未來方向可能包括：更精準的epiplexity估計、跨模態應用、與scaling law的整合、或用於意識/湧現相關討論。整體而言，這是對「資料價值」的一次深刻重新思考，強調在AI時代，選擇什麼資料來「餵養」模型，可能比模型架構本身更關鍵。論文附有程式碼（https://github.com/shikaiqiu/epiplexity），便於後續驗證與延伸。
